...
describe("Referral Single contract", function () {
  ...
  beforeEach(async function () {
    ...
    // Upgrade V2
    const ReferralSingleContractV2 = await ethers.getContractFactory("ReferralSingleContractV2");
    contract = await upgrades.upgradeProxy(contract.address, ReferralSingleContractV2);
